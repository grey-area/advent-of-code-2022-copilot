...
class Valley:
    ...
    def find_paths(self, start, end, t):
        best_t = float("inf")
        queue = deque([(start, t)])
        visited = set()
        while queue:
    ...
    def compute_shortest_route(self, start, end, t):
        return min(self.find_paths(start, end, t))
    ...
    def compute_answer(self):
        ...
        t = self.compute_shortest_route(start, end, t)
        t = self.compute_shortest_route(end, start, t)
        t = self.compute_shortest_route(start, end, t)
